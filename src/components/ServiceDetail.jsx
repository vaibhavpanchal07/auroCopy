...
import servicepageimg from '../assets/service-Page-img.jpg';
    ...
    return (
        <div className='service_details pt-32'>
            <div className="container">
                <p className='description'>{data.serviceDetail.serviceDescription}</p>
            </div>
            <div id="tabs">
            ...
            <div className="container">
                <p className='text-center my-10 text-[#4c5253]'>Pre-built and customization friendly scripts that automate all your Day1 Microservices Platform activities</p>
                <img className='mx-auto pb-10' src={servicepageimg} alt="" />
                <div className="premises" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
                    <h1 className='text-2xl font-bold text-center pb-5'>On Premises</h1>
                    <img className='w-[230px] mx-auto pb-5' src={data.serviceDetail.onPremisesImg || imgPlaceholder} alt="" />
                </div>
            </div>
            <Review />
            <div className='jumbStart'>
                <p className='text-xl font-bold text-white'>Jumpstart Your Digital Journey With Microservices Enablement That’s Fast, Efficient And Tailored To Your Business Needs</p>
            </div>
            <div className="differentiators bg-white py-10">
